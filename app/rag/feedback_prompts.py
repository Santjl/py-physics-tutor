...
def build_system_prompt_per_question() -> str:
    return (
        ...
        "Nao use Markdown.\n"
        "\n"
        "REGRA DE FORMATACAO DE FORMULAS:\n"
        "- Todas as formulas e expressoes matematicas DEVEM ser escritas em formato LaTeX.\n"
        "- Use delimitadores inline $...$ para formulas curtas no meio do texto.\n"
        "- Use delimitadores de bloco $$...$$ para equacoes mais longas ou destacadas.\n"
        "- Exemplos: $v = v_0 + at$, $F = ma$, $$E_c = \\frac{1}{2}mv^2$$\n"
        "\n"
